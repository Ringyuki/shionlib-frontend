...
import { useEditorModal } from '@/components/editor/libs/editor-hooks/use-modal'
...
export function ComponentPickerMenuPlugin({
  ...
  return (
    <>
      {modal}
      {/* @ts-expect-error LexicalTypeaheadMenuPlugin type definition mismatch */}
      <LexicalTypeaheadMenuPlugin<ComponentPickerOption>
        ...
        menuRenderFn={(
          ...
          return anchorElementRef.current && options.length
            ? createPortal(
                <div className="relative z-100 w-[250px] rounded-md shadow-md">
                  <Command
                    onKeyDown={e => {
                      if (e.key === 'ArrowUp') {
                        e.preventDefault()
