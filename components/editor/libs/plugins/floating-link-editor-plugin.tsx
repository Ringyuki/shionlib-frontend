...
import { setFloatingElemPositionForLinkEditor } from '@/components/editor/libs/utils/set-floating-elem-position-for-link-editor'
...
function FloatingLinkEditor({
  ...
  return (
    <div
      ref={editorRef}
      className="absolute top-0 left-0 w-full max-w-sm rounded-md bg-card shadow-md"
    >
