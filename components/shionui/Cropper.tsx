...
export const ImageCropContent = ({ style, className }: ImageCropContentProps) => {
  ...
  return (
    <ReactCrop
      className={cn('inline-block max-w-full max-h-[60vh] sm:max-h-[70vh]', className)}
      crop={crop}
    ...
    >
      {imgSrc && (
        <img
          alt="crop"
          className="block h-auto w-auto max-w-full max-h-[60vh] sm:max-h-[70vh]"
          onLoad={onImageLoad}
          ref={imgRef}
          src={imgSrc}
        />
...
export const ImageCropApply = ({
  ...
  return (
    <Button onClick={handleClick} size="icon" appearance="ghost" {...props}>
