...
import { MotionHighlight, MotionHighlightItem } from '@/components/shionui/motion/MotionHighlight'
...
function TabsTrigger({ ref, value, children, className, asChild, ...props }: TabsTriggerProps) {
