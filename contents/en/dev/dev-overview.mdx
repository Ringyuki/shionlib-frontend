...
Please read the [Contributing Guide](https://github.com/Ringyuki/shionlib-backend/blob/main/CONTRIBUTING.md) before submitting your Pull Request. If you have any questions, open an Issue/Discussion, or ping the maintainers in your PR.
